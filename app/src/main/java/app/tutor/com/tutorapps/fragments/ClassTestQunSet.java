...
public class ClassTestQunSet extends Fragment {
    ...
    public void getQuestionSet() {
        ...
        final String URL = AAConstants.DOMAIN_URL_OTHER_NEW + "get_question_set?subject_id=" + ((ClassTestManagement) getActivity()).getSUBJECT_ID() + "&mode=C&page=1&limit=200";
